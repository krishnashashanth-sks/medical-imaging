...
class TransformerBlock(layers.Layer):
    ...
    def call(self, inputs, training=False): # Added default value for training
...
class TokenAndPositionEmbedding(layers.Layer):
    def __init__(self, maxlen, vocab_size, embed_dim):
        ...
        self.seg_emb = layers.Embedding(input_dim=2, output_dim=embed_dim) # For 2 segments (A and B)

    def call(self, inputs):
        # inputs expects a tuple: (input_ids, segment_ids)
        ...
        segment_embeddings = self.seg_emb(segment_ids)
